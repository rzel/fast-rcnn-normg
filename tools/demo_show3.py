...
if __name__ == '__main__':
    ...
    ssdir = '/nfs/hn38/users/xiaolonw/cmp_results/supp_ss/'
    imgdir = '/nfs/hn38/users/xiaolonw/cmp_results/supp/'
    savedir = '/nfs/hn38/users/xiaolonw/cmp_results/supp_draw/'
